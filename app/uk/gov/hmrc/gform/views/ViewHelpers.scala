...
class ViewHelpers(
  ...
  /* uk.gov.hmrc.govukfrontend.views.html.layouts.govukLayout(
   *   pageTitle = title,
   *   headBlock = Some(head),
  ...
  def reportAProblemLink(ajaxFormPartialUrl: scala.Predef.String, nonJSFormPageUrl: scala.Predef.String)(
    implicit messages: play.api.i18n.Messages): play.twirl.api.HtmlFormat.Appendable = play.twirl.api.HtmlFormat.empty
